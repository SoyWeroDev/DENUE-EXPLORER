...
extension SyncError: LocalizedError {
    var errorDescription: String? {
        ...
        case .linkExpired:
            return
                "El servidor de INEGI devolvio una pagina web en lugar de un ZIP. Verifica que el enlace DENUE_BULK_DOWNLOAD_URL en tu .env siga vigente."
...
final class SyncManager {
    ...
    func downloadAndUnzipDENUE(from urlString: String) async throws -> URL {
        ...
        let targetDirectory = appSupportURL.appendingPathComponent("DENUEExplorer")
            .appendingPathComponent("RawData", isDirectory: true)
        ...
        let zipURL = appSupportURL.appendingPathComponent("DENUEExplorer").appendingPathComponent(
            "denue_temp.zip")
